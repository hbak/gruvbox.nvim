...
local base_group = {
  ...
  GruvboxRedInverted = { bg = red },
  GruvboxRedBoldInverted = { bg = red, gui = styles.bold },
  GruvboxGreenInverted = { bg = green },
  GruvboxGreenBoldInverted = { bg = green, gui = styles.bold },
  GruvboxYellowInverted = { bg = yellow },
  GruvboxYellowBoldInverted = { bg = yellow, gui = styles.bold },
  GruvboxBlueInverted = { bg = blue },
  GruvboxBlueBoldInverted = { bg = blue, gui = styles.bold },
  GruvboxPurpleInverted = { bg = purple },
  GruvboxPurpleBoldInverted = { bg = purple, gui = styles.bold },
  GruvboxAquaInverted = { bg = aqua },
  GruvboxAquaBoldInverted = { bg = aqua, gui = styles.bold },
  GruvboxOrangeInverted = { bg = orange },
  GruvboxOrangeBoldInverted = { bg = orange, gui = styles.bold },
  ...
  IdentifierInverted = "GruvboxBlueInverted",
  Function = "GruvboxGreenBold",
  FunctionInverted = "GruvboxGreenBoldInverted",
  ...
  PreProc = "GruvboxAqua",
  Include = "GruvboxAqua",
  IncludeInverted = "GruvboxAquaInverted",
  Define = "GruvboxAqua",
  Macro = "GruvboxAqua",
